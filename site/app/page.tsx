const PORTABLE_URL =
  "https://github.com/n8chur/game-reminders/releases/download/v0.0.1/GameReminders-0.0.1-win-x64-portable.zip";
const INSTALLER_URL =
  "https://github.com/n8chur/game-reminders/releases/download/v0.0.1/GameReminders-0.0.1-win-x64-setup.exe";
const SHORTCUT_URL =
  "https://github.com/n8chur/game-reminders/releases/download/v0.0.1/Game-Reminder.shortcut";
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          <div className="eyebrow-row">
            <span className="eyebrow">Alpha · v0.0.1</span>
          ...
          <div className="download-area" aria-label="Downloads and requirements">
            ...
            <div className="sync-downloads">
              ...
              <div className="sync-actions">
                <a href={SHORTCUT_URL} aria-label="Download Game-Reminder.shortcut from the v0.0.1 release">Download Game Reminder Shortcut</a>
      ...
      <section className="download-panel">
        ...
        <div className="download-panel-actions">
          ...
          <a className="release-link" href="https://github.com/n8chur/game-reminders/releases/tag/v0.0.1">View release details</a>
        </div>
      </section>
