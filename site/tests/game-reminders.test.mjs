...
test("renders the Game Reminders landing page and release downloads", async () => {
  ...
  assert.match(html, /Alpha · v0\.0\.1/);
  assert.match(html, /Download installer/);
  assert.match(html, /Download portable/);
  assert.match(html, /Download Game Reminder Shortcut/);
  assert.match(html, /Download Game-Reminder\.shortcut from the v0\.0\.1 release/);
  assert.match(html, /releases\/download\/v0\.0\.1\/Game-Reminder\.shortcut/);
  ...
  assert.match(html, /GameReminders-0\.0\.1-win-x64-setup\.exe/);
  assert.match(html, /GameReminders-0\.0\.1-win-x64-portable\.zip/);
