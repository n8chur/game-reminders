...
Assert-ShortcutCondition ($source.distribution.status -eq 'requires-apple-export') 'Unsigned source must not claim to be importable.'
...
Assert-ShortcutCondition ($save.folder -eq 'gameRemindersFolder/inbox') 'Reminder must be staged in inbox.'
